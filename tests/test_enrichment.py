"""
Automated Pytest for mtb-orchestrator-pro Enrichment Modules.
"""
import sys
...
from enrichment import (
    ClinicalGuidelineVersioningEngine,
    MultipatientParallelOrchestrationEngine,
    DecisionAuditTrailEngine,
    AdrInteractionCheckingEngine,
    ProtocolOutcomeTrackingEngine,
    MtborchestratorproEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = MtborchestratorproEnrichmentSuite()
